...
export const createGroupConversationSchema = z.object({
  ...
  participantUserIds: z
    .array(
      z.string().trim().min(1, "participant user id is required")
    )
...
export const messageAttachmentInputSchema = z.object({
  ...
  mimeType: z
    .string()
    .trim()
    .max(255, "mimeType cannot exceed 255 characters")
    .nullable()
    .optional(),
  fileName: z
    .string()
...
export const sendMessageSchema = z.object({
  ...
  replyToMessageId: z
    .string()
    .trim()
    .min(1, "replyToMessageId cannot be empty")
    .nullable()
    .optional(),
  attachments: z
...
export const addReactionSchema = z.object({
  reaction: z
    ...
    .max(50, "reaction cannot exceed 50 characters"),
});
